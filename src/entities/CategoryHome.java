...
public class CategoryHome {
	...
	public Category findById(java.lang.Integer id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession().get("entities.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entities.Category")
