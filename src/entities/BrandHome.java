...
public class BrandHome {
	...
	public Brand findById(java.lang.Integer id) {
		...
		try {
			Brand instance = (Brand) sessionFactory.getCurrentSession().get("entities.Brand", id);
			if (instance == null) {
	...
	public List findByExample(Brand instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entities.Brand")
