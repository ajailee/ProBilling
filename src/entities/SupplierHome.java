...
public class SupplierHome {
	...
	public Supplier findById(java.lang.Long id) {
		...
		try {
			Supplier instance = (Supplier) sessionFactory.getCurrentSession().get("entities.Supplier", id);
			if (instance == null) {
	...
	public List findByExample(Supplier instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entities.Supplier")
