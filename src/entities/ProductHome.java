...
public class ProductHome {
	...
	public Product findById(java.lang.String id) {
		...
		try {
			Product instance = (Product) sessionFactory.getCurrentSession().get("entities.Product", id);
			if (instance == null) {
	...
	public List findByExample(Product instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entities.Product")
