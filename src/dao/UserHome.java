...
public class UserHome {
	...
	public User findById(java.lang.Long id) {
		...
		try {
			User instance = (User) sessionFactory.getCurrentSession().get("dao.User", id);
			if (instance == null) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("dao.User").add(Example.create(instance))
					.list();
